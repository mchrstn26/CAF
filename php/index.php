        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <div class="border-head">
              <h3>WELCOME TO CAF ADMIN PANEL, <?php echo $admin ?></h3>
            </div>
            ...
            <div class="col-md-4 mb">
                ...
                <div class="grey-panel pn">
                  <div class="grey-header">
                    <h5><a href="payment_log.php">TOP DEPOSIT OF THE MONTH</a></h5>
                  </div>
            ...
            <div class="col-md-4 mb">
                ...
                <div class="green-panel pn">
                  <div class="green-header">
                    <h5><a href="mostNumber.php">TOP BET OF THE MONTH</a></h5>
                  </div>
                  <p><img src="img/ui-zac.jpg" class="img-circle" width="50"></p>
                  <p><b>Zac Snider</b></p>
                  <div class="row">
              ...
              <div class="col-md-4 mb">
                ...
                <div class="darkblue-panel pn">
                  <div class="darkblue-header">
                    <h5><a href="client_info.php">MOST USER</a></h5>
                  </div>
                  <p><img src="img/ui-zac.jpg" class="img-circle" width="50"></p>
                  <p><b>Zac Snider</b></p>
                  <div class="row">
