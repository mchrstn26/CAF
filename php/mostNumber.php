...
<section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="sorting.php">Most Number Pick</a></li>
	...
	<section id="main-content">
      <section class="wrapper">
        <div class="container">
			        <h3><i class="fa fa-angle-right"></i> TOP 5 MOST BET NUMBER</h3>
      ...
      <table id="example" class="table table-striped table-bordered">
        ...
        <tbody>
          <?php
					...
					$sql = 'SELECT betDate, number, 
					        COUNT(*) as jumlah 
					        FROM LogLuckyNumber GROUP BY number order by jumlah DESC
					        LIMIT 10';
                            //SELECT *, COUNT(number) AS TOTAL FROM LogLuckyNumber ORDER BY TOTAL
					;
