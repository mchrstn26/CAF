...
if(isset($_POST['tombol_tambah'])){
    ...
    $add_status = $lib->add_data($nominal, $harga);
    if($add_status){
  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Add Price List</h3>

        <h4 class="title">New Price</h4>
            <div id="message"></div>
            <form method="post" action="">
                <div class="form-group row">
                    <label for="nominal" class="col-sm-2 col-form-label">Diamond</label>
                    <div class="col-sm-10">
